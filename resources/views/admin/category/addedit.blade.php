...
<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow sticky">
    ...
    <ul class="navbar-nav ">
        <li class="nav-item"> <a class="nav-link line-1" href="admin/category/list" ><i class="fa fa-chevron-left" aria-hidden="true"></i> <span class="mobile-hide">Quay lại trang danh sách phòng ban</span> </a> </li>
    </ul>
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <label>SKU</label>
                            <input value="{{ isset($data) ? $data->sku : '' }}" name="sku" placeholder="sku" type="text" class="form-control">
                        </div>
                    </div>
                    <!-- <div class="col-md-2">
                        <div class="form-group">
