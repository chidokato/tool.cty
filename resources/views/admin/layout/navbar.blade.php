...
<!-- <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar"> -->
    ...
    <li class="nav-item">
        <a class="nav-link" href="admin/category/list"><i class="fas fa-fw fa-chart-area"></i><span>Phòng ban</span></a>
    </li>
    <!-- <li class="nav-item">
        <a class="nav-link" href="admin/product/list"><i class="fas fa-fw fa-chart-area"></i><span>Sản phẩm</span></a>
    </li> -->
    <li class="nav-item">
        <a class="nav-link" href="admin/news/list"><i class="fas fa-fw fa-chart-area"></i><span>Duyệt phiếu</span></a>
    </li>
    <!-- <li class="nav-item">
