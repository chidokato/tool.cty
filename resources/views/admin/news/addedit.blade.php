            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="d-flex row-date" id="sandbox-container">
                                <select class="form-control" name="buoi1">
                                    <option value="0">Sáng</option>
                                    <option value="0.5">Chiều</option>
                                </select>
                                <input type="text" class="form-control" name="ngay1" placeholder="" value="{{ date('m/d/Y') }}" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="d-flex row-date" id="sandbox-container">
                                <select class="form-control" name="buoi2">
                                    <option value="0">Sáng</option>
                                    <option value="0.5">Chiều</option>
                                </select>
                                <input type="text" class="form-control" name="ngay2" value="{{ date('m/d/Y') }}" />
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="hinhthuc">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label>Lý do</label>
                            <textarea rows="3" name="lydo" class="form-control">{{ isset($data) ? $data->detail : '' }}</textarea>
                        </div>
                    </div>
                </div>
                <div class="row">
