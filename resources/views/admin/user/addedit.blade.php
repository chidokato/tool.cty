...
<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow sticky">
    ...
    <ul class="navbar-nav ">
        <li class="nav-item"> <a class="nav-link line-1" href="admin/user/list" ><i class="fa fa-chevron-left" aria-hidden="true"></i> <span class="mobile-hide">Quay lại trang danh sách người dùng</span> </a> </li>
    </ul>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <select name='permission' class="form-control">
                                ...
                                <!-- <option <?php if(isset($data) && $data->permission==2){ echo 'selected'; } ?> value="2">author</option> -->
                                <!-- <option <?php if(isset($data) && $data->permission==3){ echo 'selected'; } ?> value="3">member</option> -->
                        ...
                        <div class="form-group">
                            ...
                            <select name='position' class="form-control">
                                <option value="">...</option>
                                <option <?php if(isset($data) && $data->position=='Trưởng phòng'){ echo 'selected'; } ?> value="Trưởng phòng">Trưởng phòng</option>
                                <option <?php if(isset($data) && $data->position=='Nhân viên'){ echo 'selected'; } ?> value="Nhân viên">Nhân viên</option>
                                <option <?php if(isset($data) && $data->position=='Cộng tác viên'){ echo 'selected'; } ?> value="Cộng tác viên">Cộng tác viên</option>
                            </select>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label>Mã NV</label>
                            <input name="sku" value="{{ isset($data) ? $data->sku : '' }}" placeholder="Mã nv" type="text" class="form-control">
                        </div>
                        <div class="form-group">
